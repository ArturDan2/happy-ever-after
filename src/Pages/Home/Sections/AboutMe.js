  ...
  return (
    <section ref={element} className={`about-me ${inView ? "animate" : ''}`}>
        <div className='about-me__text-container'>
            ...
            <p className='about-me__p'>Jestem organizatorką ślubów pracującą na terenie Poznania i okolic. Połączenie mojej romantycznej duszy ze skłonnością do perfekcyjnego planowania wszystkiego z
...
rozwoju w obszarze organizacji wesel i ślubów. Mogę więc śmiało powiedzieć, że towarzyszenie Wam na drodze do upragnionego <span className='about-me__keep-together'>Happy Ever After </span>
