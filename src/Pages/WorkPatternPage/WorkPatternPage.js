    ...
    <div className="work-pattern-page slide-in sub-page">
      ...
      <div className="work-pattern-page__header-container">
        ...
        <div className="work-pattern-page__text">
          <p>
            Szukacie organizatora ślubów działającego w obrębie Wielkopolski?
            Cieszę się, że trafiliście właśnie do mnie! W mojej pracy cenię
            sobie swobodę, zorganizowanie i zaufanie. Już od samego początku
          ...
          <p>
            ...
            poznamy i przedstawię Wam moją ofertę. Możemy spotkać się osobiście
            na terenie Wielkopolski lub online poprzez platformy multimedialne.
          </p>
        </div>
      </div>
      <div className="work-pattern-page__steps">
        <div className="work-pattern-page__step">
          ...
          <ul>
            <li>
              poproszę was o wspólne wypełnienie ankiety Pary Młodej, która
              pomoże mi określić wasze oczekiwania
            </li>
            <li>porozmawiamy o Waszych inspiracjach</li>
            <li>
              wspólnie omówimy styl, charakter i koncepcję Waszej uroczystości
            </li>
            <li>wstępnie omówimy ofertę naszej agencji</li>
            <li>
              odpowiem na Wasze pytania i postaram się rozwiać wszystkie
              wątpliwości
            </li>
          </ul>
        </div>
        <div className="work-pattern-page__step">
          ...
          <ul>
            <li>
              przedstawię ofertę, którą przygotowałam dla Was na podstawie
              ankiety i naszych rozmów
            </li>
            <li>
              omówimy kosztorys ślubny oraz zakres prac, jakie dla Was wykonam.
            </li>
          </ul>
        </div>
        <div className="work-pattern-page__step">
